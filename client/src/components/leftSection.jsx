...
const LeftSection = () => {
  return (
    <div data-testid="left-auth-section" className="hidden lg:flex flex-col bg-linear-to-br from-white-600 to-white-500 text-black p-12 relative overflow-hidden ml-20">
      ...
      {/* Content */}
      <div data-testid="left-auth-content" className="relative z-10">
        {/* Logo */}
        <div data-testid="brand-header" className="flex items-center gap-3 mb-12">
          ...
          <h1 data-testid="brand-title" className="text-xl font-bold">Recruitment CRM</h1>
        </div>

        {/* Welcome Section */}
        <div data-testid="welcome-message" className="mb-12">
          <h2 data-testid="welcome-title" className="text-4xl font-bold mb-4 leading-tight">Welcome Back! 👋</h2>
          <p data-testid="welcome-subtitle" className="text-black-100 text-lg">
            Sign in to continue managing your recruitment process.
          </p>
        </div>

        {/*Illustration Image*/}
        <div data-testid="illustration-wrapper">
            <img data-testid="auth-illustration" src={workingImage} alt="Working illustration" className="w-full max-w-sm"/>
        </div>

        {/* Features */}
        <div data-testid="feature-list" className="space-y-6">
          {/* Feature 1 */}
          <div data-testid="feature-1" className="flex items-start gap-4">
          ...
          {/* Feature 2 */}
          <div data-testid="feature-2" className="flex items-start gap-4">
            <div className="w-12 h-12 bg-indigo-600 bg-opacity-20 rounded-lg flex items-center justify-center shrink-0 border border-white border-opacity-30 backdrop-blur-sm">
          ...
          {/* Feature 3 */}
          <div data-testid="feature-3" className="flex items-start gap-4">
            <div className="w-12 h-12 bg-indigo-600 bg-opacity-20 rounded-lg flex items-center justify-center shrink-0 border border-white border-opacity-30 backdrop-blur-sm">
